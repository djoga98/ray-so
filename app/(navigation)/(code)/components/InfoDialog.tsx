...
export function InfoDialog({ mode = "images" }: InfoDialogProps) {
      ...
      <DialogContent size="large">
        <div className="flex gap-8">
          <div className="flex flex-col gap-3 flex-1 text-[13px] text-gray-11 leading-relaxed">
            ...
            {isVideoMode ? (
              <>
                <p>Code Videos by Raycast is a tool to create polished typing animations of your code.</p>
                <p>
                  Pick a theme from a range of syntax colors and backgrounds, the language of your code and choose
                  between light or dark mode.
                </p>
                <p>
                  When you’re ready, open export video in the top-right corner to configure timing, cursor visibility
                  and resolution before generating a WebM export.
                </p>
                <p>Preview the animation on the canvas before exporting if you want to validate the pacing.</p>
              </>
            ) : (
              <>
            ...
            <SocialFooter referral={isVideoMode ? "code-video" : "code-image"} />
          </div>
          ...
          <div className="flex-1 flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-4">
              ...
              {isVideoMode ? (
                <Shortcut keys={["⌘", "K"]}>Open video export</Shortcut>
              ) : (
                <>
